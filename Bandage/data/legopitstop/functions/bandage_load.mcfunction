...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {bandage:{namespace:"bandage",pack_version:"1.0.0",mc_version:"1.16",multiplayer_tested:"no",has_config:"no",pack:{title:"Bandage",description:"Bandages!",uuid:"2cb304ae-8023-4a92-8c3d-c62672f013f0"}}}
...
execute unless data storage legopitstop:registered_datapacks {mc_version:"1.16"} run tellraw @a ["",{"translate":"Unsupported version!","color":"dark_red"}," ",{"text":"Recommended version"}," ",{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.bandage.mc_version"}]