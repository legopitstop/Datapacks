...
execute as @a[nbt={SelectedItem:{tag:{id:"bandage:water_bandage"}}}] unless entity @s[nbt={Inventory:[{Slot:-106b}]}] as @s[nbt=!{Inventory:[{Slot:-106b,tag:{invisable:true}}]}] run replaceitem entity @s weapon.offhand arrow{CustomModelData:50,invisable:true,display:{Name:'{"text":""}'}}
