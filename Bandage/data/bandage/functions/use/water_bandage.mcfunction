...
# MOD message
tellraw @a[tag=LPSMOD] ["",{"text":"[Modirator]"}," ",{"translate":"%s Successfully used a water_bandage","color":"green","with":[{"selector":"@s"}]}]
...
effect give @s minecraft:water_breathing 60 1 false