...
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_log run tag @s add BarkedCrafted
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_log[axis=x] run setblock ~ ~-1 ~ mangrove_log[axis=x]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_log[axis=y] run setblock ~ ~-1 ~ mangrove_log[axis=y]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_log[axis=z] run setblock ~ ~-1 ~ mangrove_log[axis=z]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_log run tag @s add BarkedCrafted
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_log[axis=x] run setblock ~ ~-1 ~ cherry_log[axis=x]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_log[axis=y] run setblock ~ ~-1 ~ cherry_log[axis=y]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_log[axis=z] run setblock ~ ~-1 ~ cherry_log[axis=z]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ stripped_bamboo_block run tag @s add BarkedCrafted
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ stripped_bamboo_block[axis=x] run setblock ~ ~-1 ~ bamboo_block[axis=x]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ stripped_bamboo_block[axis=y] run setblock ~ ~-1 ~ bamboo_block[axis=y]
execute at @s[type=item,nbt={Item:{Count:4b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ stripped_bamboo_block[axis=z] run setblock ~ ~-1 ~ bamboo_block[axis=z]
# woods
...
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_wood run tag @s add BarkedCrafted
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_wood[axis=x] run setblock ~ ~-1 ~ mangrove_wood[axis=x]
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_wood[axis=y] run setblock ~ ~-1 ~ mangrove_wood[axis=y]
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ stripped_mangrove_wood[axis=z] run setblock ~ ~-1 ~ mangrove_wood[axis=z]
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_wood run tag @s add BarkedCrafted
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_wood[axis=x] run setblock ~ ~-1 ~ cherry_wood[axis=x]
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_wood[axis=y] run setblock ~ ~-1 ~ cherry_wood[axis=y]
execute at @s[type=item,nbt={Item:{Count:6b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ stripped_cherry_wood[axis=z] run setblock ~ ~-1 ~ cherry_wood[axis=z]
...
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ crafting_table run tag @s add BarkedCraftedPaper
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:mangrove_bark"}}}] if block ~ ~-0.1 ~ crafting_table run summon item ~ ~ ~ {Item:{id:"minecraft:paper",Count:1b}}
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ crafting_table run tag @s add BarkedCraftedPaper
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:cherry_bark"}}}] if block ~ ~-0.1 ~ crafting_table run summon item ~ ~ ~ {Item:{id:"minecraft:paper",Count:1b}}
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ crafting_table run tag @s add BarkedCraftedPaper
execute at @s[type=item,nbt={Item:{Count:1b,tag:{id:"barked:bamboo_sheath"}}}] if block ~ ~-0.1 ~ crafting_table run summon item ~ ~ ~ {Item:{id:"minecraft:paper",Count:1b}}
