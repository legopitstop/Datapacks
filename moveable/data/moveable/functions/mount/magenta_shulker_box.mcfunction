# Desc: Add a magenta_shulker_box to the minecart
#
# Called By: moveable:minecart

summon chest_minecart ~ ~ ~ {CustomDisplayTile: true, DisplayOffset: 6,DisplayState: {Name: "minecraft:magenta_shulker_box"}, Tags: ["moveable", "init"]}
