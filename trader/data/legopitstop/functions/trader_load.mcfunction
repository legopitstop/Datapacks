...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {trader:{namespace:"trader",pack_version:"1.2.0",mc_version:"1.18",multiplayer_tested:"yes",has_config:"yes",pack:{title:"Convert Traders",description:"Convert wandering traders to regular traders!",uuid:"838c2491-44bb-4abc-baaf-28a99b86a07f"}}}
...
execute if score DataVersion LPSDatapacks matches 2860..2865 run data modify storage legopitstop:registered_datapacks mc_version set value "1.18"
...
# Reload Message
tellraw @a ["",{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.pack.title","color":"yellow","hoverEvent":{"action":"show_text","contents":{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.pack.description","color":"white"}}}," ",{"translate":"[%s]","color":"green","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.pack_version"}],"hoverEvent": {"action":"show_text","contents":["",{"translate":"Pack Version: %s","color":"white","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.pack_version","color":"gray"}]},"\n",{"translate":"MC Version: %s","color":"white","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.mc_version","color":"gray"}]}]}}," ",{"text":"ℹ","color":"blue","hoverEvent": {"action":"show_text","contents": ["",{"translate":"Namespace(s): %s","color":"white","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.namespace","color":"gray"}]},"\n",{"translate":"Has Config: %s","color":"white","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.has_config","color":"gray"}]},"\n",{"translate":"Multiplayer Tested: %s","color":"white","with":[{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.multiplayer_tested","color":"gray"}]},"\n",{"text":"1.18 Update by ","color":"white"},{"text":"FunkyToc","color":"gray"}]}}]

# unsupported version message
execute unless data storage legopitstop:registered_datapacks {mc_version:"1.18"} run tellraw @a ["",{"translate":"Unsupported version!","color":"dark_red"}," ",{"text":"Recommended version"}," ",{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.trader.mc_version"}]