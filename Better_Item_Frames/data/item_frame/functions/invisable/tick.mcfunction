...
# Hide item frame
execute at @e[type=potion,nbt={Item:{tag:{Potion:"minecraft:invisibility"}}}] as @e[type=#item_frame:item_frames,distance=..1.75,nbt={Invisible:0b}] run function item_frame:invisable/hide
execute at @e[type=potion,nbt={Item:{tag:{Potion:"minecraft:long_invisibility"}}}] as @e[type=#item_frame:item_frames,distance=..1.75,nbt={Invisible:0b}] run function item_frame:invisable/hide

# Show item frame
execute at @e[type=potion,nbt={Item:{tag:{Potion:"minecraft:water"}}}] as @e[type=#item_frame:item_frames,distance=..1.75,nbt={Invisible:1b}] run function item_frame:invisable/show
