...
#
# Called By: poses:armor_stand/find_power
...
execute store success score #bool poses.util run data modify storage poses:poses temp.power set from storage poses:poses find
