...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {spawnercraft:{namespace:"spawnercraft",pack_version:"1.7.0",mc_version:"1.16",multiplayer_tested:"no",has_config:"yes",pack:{title:"Spawner Craft",description:"Adds recipes for all the spawn eggs.",uuid:"778f1163-b19b-46db-999b-6d64d6c42098"}}}
...
execute unless data storage legopitstop:registered_datapacks {mc_version:"newer"} run tellraw @a ["",{"translate":"Unsupported version!","color":"dark_red"}," ",{"text":"Recommended version"}," ",{"storage":"legopitstop:registered_datapacks","nbt":"datapacks.spawnercraft.mc_version"}]
