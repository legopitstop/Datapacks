...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {cup:{namespace:"cup",pack_version:"1.0.0",mc_version:"1.17",multiplayer_tested:"no",has_config:"no",pack:{update_url: "URL",title:"Coal Under Pressure",description:"Now thats a lot of pressure! ",uuid:"b2c0fed4-2e9f-46ec-8f56-6ab15b0e79a7"}}}
