...
# Register Datapack
data modify storage legopitstop:registered_datapacks datapacks merge value {item_frame:{namespace:"item_frame",pack_version:"1.0.0",mc_version:"1.17",multiplayer_tested:"no",has_config:"no",pack:{update_url: "URL",title:"CCW Item Frames",description:"Rotate item frames the other way by Shift + Clicking!",uuid:"c3f51f10-6160-4e6d-8c92-7928b9d40d9c"}}}
