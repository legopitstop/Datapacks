...
# 1.19   3080 - 3105
# 1.20   3442 - 3463
data modify storage lps:datapacks pack set value {id: 109906, name: 'Botanic Pots', description:'You can now place flowers in Decorated Pots!', version: "1.0.2", minDataVersion: 3442, updateChecker: '{"text": "[Update Checker]", "clickEvent": {"action": "open_url", "value": "https://legopitstop.github.io/Update_Checker/update-checker.html?updateJSONURL=https%3A%2F%2Fraw.githubusercontent.com%2Flegopitstop%2FDatapacks%2Fmain%2FBotanic_Pots%2Fupdate.json&mcversion=1.20&modversion=1.0.2"}}'}
