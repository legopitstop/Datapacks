...
#execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","customDisc"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{music_disc:{}}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscChrysopoeia"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_chrysopoeia"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscCustom1"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_custom1"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscCustom2"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_custom2"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscCustom3"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_custom3"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscCustom4"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_custom4"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscCustom5"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_custom5"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscRubedo"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_rubedo"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscSample"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_sample"}}}
execute at @a run fill ~10 ~10 ~10 ~-10 ~-10 ~-10 command_block{auto:1b,Command:'summon minecraft:marker ~ ~-0.5 ~ {Tags:["jukebox","DiscSoBelow"]}'} replace jukebox[has_record=true]{RecordItem:{tag:{FakeDisc:0b,id:"moremusic:music_disc_so_below"}}}

# Run function at cloud if their is a command block at its place
#execute at @e[tag=jukebox] at @e[tag=customDisc] if block ~ ~ ~ command_block run function moremusic:music_disc/custom_disc
...
#execute at @e[type=item,nbt={Item:{tag:{FakeDisc:1b,music_disc:{}}}}] run function give:moremusic/sample
