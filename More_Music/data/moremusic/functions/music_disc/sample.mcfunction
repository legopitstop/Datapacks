...
setblock ~ ~ ~ minecraft:jukebox[has_record=true]{RecordItem:{id:"minecraft:music_disc_13",Count:1b,tag:{FakeDisc:1b,id:"moremusic:music_disc_sample"}}} replace
...
title @p actionbar [{"translate":"record.nowPlaying","with":[{"translate":"item.moremusic.music_disc_sample.desc"}]}]