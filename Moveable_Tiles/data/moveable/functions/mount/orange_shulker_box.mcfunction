# Desc: Add a orange_shulker_box to the minecart
#
# Called By: moveable:minecart

summon chest_minecart ~ ~ ~ {CustomDisplayTile: true,DisplayOffset: 6, DisplayState: {Name: "minecraft:orange_shulker_box"}, Tags: ["moveable", "init"]}
