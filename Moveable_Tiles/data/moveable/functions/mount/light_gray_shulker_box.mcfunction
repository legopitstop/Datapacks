# Desc: Add a light_gray_shulker_box to the minecart
#
# Called By: moveable:minecart

summon chest_minecart ~ ~ ~ {CustomDisplayTile: true, DisplayOffset: 6,DisplayState: {Name: "minecraft:light_gray_shulker_box"}, Tags: ["moveable", "init"]}
