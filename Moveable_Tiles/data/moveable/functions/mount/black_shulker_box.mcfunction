# Desc: Add a black_shulker_box to the minecart
#
# Called By: moveable:minecart

summon chest_minecart ~ ~ ~ {CustomDisplayTile: true, DisplayOffset: 6,DisplayState: {Name: "minecraft:black_shulker_box"}, Tags: ["moveable", "init"]}
