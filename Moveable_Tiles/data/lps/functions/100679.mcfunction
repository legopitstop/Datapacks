...
# 1.19.1 3106 - 3117
# 1.19   3080 - 3105
data modify storage lps:datapacks pack set value {id: 100679, name: 'Moveable Tiles', description:'Moveable Spawners, Chests, Barrels and More!', version: "1.0.0", minDataVersion: 3105, updateChecker: '{"text": "[Update Checker]", "clickEvent": {"action": "open_url", "value": "https://legopitstop.github.io/Update_Checker/update-checker.html?updateJSONURL=https%3A%2F%2Fraw.githubusercontent.com%2Flegopitstop%2FDatapacks%2Fmain%2FMoveable_Tiles%2Fupdate.json&mcversion=1.19.3&modversion=beta"}}'}
